...
namespace Pubstars2.Migrations
{
    ...
    [Migration("20161112230500_local2")]
    partial class local2
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Pubstars2.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
                    ...
                    b.Property<string>("psPassword");

                    b.Property<double>("ratingMean");

                    b.Property<double>("ratingUncertainty");
            ...
            modelBuilder.Entity("Pubstars2.Models.PubstarsStats.PubstarsSeason", b =>
                {
            ...
            modelBuilder.Entity("Pubstars2.Models.PubstarsStats.PubstarsPlayer", b =>
                {
                    b.HasOne("Pubstars2.Models.PubstarsStats.PubstarsGame")
                        .WithMany("players")
